module.exports = (env, callback) ->
  ...
  tagDefaults = 
    filename: '/blogtag/%s/%d/index.html' # => tag/:tagName/:pageNum/index.html
  ...
  getArticles = (contents) -> 
    if contents['blog'][options.articles] 
    then contents['blog'][options.articles]._.directories.map (item) -> item.index
    else []
